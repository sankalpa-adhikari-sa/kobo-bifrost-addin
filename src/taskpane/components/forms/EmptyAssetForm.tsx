...
interface EmptyAssetFormProps {
  control: Control<EmptySurveyAssetFormData>;
  errors: FieldErrors<EmptySurveyAssetFormData>;
  isLoading: boolean;
}
const EmptyAssetForm = ({ control, errors }: EmptyAssetFormProps) => {
  return (
